...
rem Build siglus for Windows using MSVC targets.
...
rem   CRATE_PKG=siglus_scene_vm  (cargo package name)
rem   BIN_NAME=siglus_engine      (cargo binary name)
rem   APP_NAME=siglus             (output exe name)
rem --------------------------------------------
...
if "%CRATE_PKG%"=="" set "CRATE_PKG=siglus_scene_vm"
if "%BIN_NAME%"=="" set "BIN_NAME=siglus_engine"
if "%APP_NAME%"=="" set "APP_NAME=siglus"
...
echo   set CRATE_PKG=siglus_scene_vm
echo   set APP_NAME=siglus
exit /b 2
