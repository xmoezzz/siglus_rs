...
impl Default for IdMap {
    fn default() -> Self {
        let mut out = Self {
            ...
            form_global_mouse: 87,
            form_global_keylist: 88,
            form_global_key: 89,

            // Optional global forms (disabled by default).
            form_global_syscom: 63,
            form_global_script: 64,
            form_global_system: 92,
            form_global_frame_action: 79,
            form_global_frame_action_ch: 0,

            form_global_math: 0,
            form_global_cgtable: 78,
            ...
            screen_color_b: 7,
            screen_color_rate: 8,
            screen_color_add_r: 19,
            screen_color_add_g: 20,
            screen_color_add_b: 21,

            screen_x_eve: 11,
            screen_y_eve: 12,
            screen_z_eve: 13,
            screen_mono_eve: 14,
            screen_reverse_eve: 15,
            screen_bright_eve: 16,
            screen_dark_eve: 17,
            screen_color_r_eve: 18,
            screen_color_g_eve: 22,
            screen_color_b_eve: 23,
            screen_color_rate_eve: 24,
            screen_color_add_r_eve: 28,
            screen_color_add_g_eve: 29,
            screen_color_add_b_eve: 30,

            effect_init: 30,
            effect_wipe_copy: 31,
            effect_wipe_erase: 32,
            effect_x: 0,
            effect_y: 1,
            effect_z: 2,
            effect_mono: 3,
            ...
            effect_color_g: 8,
            effect_color_b: 9,
            effect_color_rate: 10,
            effect_color_add_r: 11,
            effect_color_add_g: 12,
            effect_color_add_b: 13,
            effect_x_eve: 14,
            effect_y_eve: 15,
            effect_z_eve: 16,
            effect_mono_eve: 17,
            effect_reverse_eve: 18,
            effect_bright_eve: 19,
            effect_dark_eve: 20,
            effect_color_r_eve: 21,
            effect_color_g_eve: 22,
            effect_color_b_eve: 23,
            effect_color_rate_eve: 24,
            effect_color_add_r_eve: 25,
            effect_color_add_g_eve: 26,
            effect_color_add_b_eve: 27,
            effect_begin_order: 28,
            effect_end_order: 29,
            effect_begin_layer: 33,
            effect_end_layer: 34,
            ...
            obj_z: 0x05,
            obj_create: 0x26,
            obj_create_number: 0x84,
            obj_create_weather: 0x81,
            obj_create_mesh: 0x2B,
            obj_create_billboard: 0x2D,
            obj_create_save_thumb: 0,
            obj_create_capture_thumb: 0,
            obj_create_capture: 0,
            obj_create_movie: 0x78,
            obj_create_movie_loop: 0x79,
            obj_create_movie_wait: 0x7A,
            obj_create_movie_wait_key: 0x8F,
            obj_create_emote: 0,
            obj_create_copy_from: 0,
            obj_set_weather_param_type_a: 0x82,
            obj_set_weather_param_type_b: 0x83,
            obj_pause_movie: 0x7D,
            obj_resume_movie: 0x7E,
            obj_seek_movie: 0x89,
            obj_get_movie_seek_time: 0x8A,
            obj_check_movie: 0x7F,
            obj_wait_movie: 0x80,
            obj_wait_movie_key: 0x8E,
            obj_end_movie_loop: 0,
            obj_set_movie_auto_free: 0xAC,
            obj_clear_button: 0x3D,
            obj_set_button: 0x2A,
            obj_set_button_group: 0xA4,
            obj_set_button_pushkeep: 0x62,
            obj_get_button_pushkeep: 0x77,
            obj_set_button_alpha_test: 0xAF,
            obj_get_button_alpha_test: 0xB0,
            obj_set_button_state_normal: 0x5F,
            obj_set_button_state_select: 0x60,
            obj_set_button_state_disable: 0x61,
            obj_get_button_state: 0x76,
            obj_get_button_hit_state: 0x7B,
            obj_get_button_real_state: 0x7C,
            obj_set_button_call: 0x1A,
            obj_clear_button_call: 0x3C,
            obj_frame_action: 0x34,
            obj_frame_action_ch: 0x73,
            obj_load_gan: 0x35,
            obj_start_gan: 0x01000001,

            obj_wipe_copy: 0x38,
            obj_wipe_erase: 0x5C,
            obj_click_disable: 0x8B,
            ...
            obj_clip_top: 0x14,
            obj_clip_right: 0x15,
            obj_clip_bottom: 0x16,
            obj_set_clip: 0xA0,
            obj_src_clip_left: 0x96,
            obj_src_clip_top: 0x97,
            obj_src_clip_right: 0x98,
            obj_src_clip_bottom: 0x99,
            obj_set_src_clip: 0xA1,
            obj_tr: 0x1B,
            obj_mono: 0x1C,
            obj_reverse: 0x1D,
            obj_bright: 0x1E,
            ...
            obj_color_b: 0x22,
            obj_color_rate: 0x17,
            obj_color_add_r: 0x39,
            obj_color_add_g: 0x3A,
            obj_color_add_b: 0x3B,
            ...
            obj_center_rep_x: 0x09,
            obj_center_rep_y: 0x0A,
            obj_center_rep_z: 0x0B,
            obj_set_center_rep: 0x9F,

            obj_clip_use: 0x12,
            obj_src_clip_use: 0x95,

            obj_mask_no: 0x91,
            obj_tonecurve_no: 0x6D,
            obj_culling: 0x92,
            obj_alpha_test: 0x93,
            obj_alpha_blend: 0x94,
            obj_blend: 0x2E,
            obj_light_no: 0xA8,
            obj_fog_use: 0x90,
            ...
            obj_center_x_eve: 0x43,
            obj_center_y_eve: 0x44,
            obj_center_z_eve: 0x45,

            obj_center_rep_x_eve: 0x46,
            obj_center_rep_y_eve: 0x47,
            obj_center_rep_z_eve: 0x48,

            obj_scale_x_eve: 0x49,
            obj_scale_y_eve: 0x4A,
            obj_scale_z_eve: 0x4B,

            obj_rotate_x_eve: 0x4C,
            obj_rotate_y_eve: 0x4D,
            obj_rotate_z_eve: 0x4E,

            obj_clip_left_eve: 0x4F,
            obj_clip_top_eve: 0x50,
            obj_clip_right_eve: 0x51,
            obj_clip_bottom_eve: 0x52,

            obj_src_clip_left_eve: 0x53,
            obj_src_clip_top_eve: 0x54,
            obj_src_clip_right_eve: 0x55,
            obj_src_clip_bottom_eve: 0x56,
            ...
            obj_mono_eve: 0x58,
            obj_reverse_eve: 0x59,
            obj_bright_eve: 0x5A,
            obj_dark_eve: 0x69,

            obj_color_r_eve: 0x6A,
            obj_color_g_eve: 0x6B,
            obj_color_b_eve: 0x6C,
            obj_color_rate_eve: 0x9A,
            obj_color_add_r_eve: 0x9B,
            obj_color_add_g_eve: 0x9C,
            obj_color_add_b_eve: 0x9D,

            obj_get_pat_cnt: 0xA9,
            obj_get_size_x: 0,
            obj_get_size_y: 0,
            obj_get_size_z: 0,
            obj_get_pixel_color_r: 0x66,
            obj_get_pixel_color_g: 0x65,
            obj_get_pixel_color_b: 0x64,
            obj_get_pixel_color_a: 0x67,
            ...
            obj_set_string: 0x63,
            obj_get_string: 0x87,
            obj_set_string_param: 0x68,
            obj_set_number: 0x85,
            obj_get_number: 0x88,
            obj_set_number_param: 0x86,
...
impl IdMap {
    pub fn load_from_env() -> Self {
        ...
        load_u32_name_map_env(
            "SIGLUS_USER_CMD_MAP",
            "SIGLUS_USER_CMD_MAP_FILE",
            &mut out.user_cmd_names,
        );
        load_u32_name_map_env(
            "SIGLUS_CALL_CMD_MAP",
            "SIGLUS_CALL_CMD_MAP_FILE",
            &mut out.call_cmd_names,
        );
        load_u32_name_map_env(
            "SIGLUS_FUNCTION_MAP",
            "SIGLUS_FUNCTION_MAP_FILE",
            &mut out.function_names,
        );
        load_u32_name_map_env(
            "SIGLUS_CALL_PROP_MAP",
            "SIGLUS_CALL_PROP_MAP_FILE",
            &mut out.call_prop_names,
        );
        load_u32_name_map_env(
            "SIGLUS_USER_PROP_MAP",
            "SIGLUS_USER_PROP_MAP_FILE",
            &mut out.user_prop_names,
        );

        // Sub-op name maps.
        load_i64_name_map_env(
            "SIGLUS_BGM_OP_MAP",
            "SIGLUS_BGM_OP_MAP_FILE",
            &mut out.bgm_op_names,
        );
        load_i64_name_map_env(
            "SIGLUS_SE_OP_MAP",
            "SIGLUS_SE_OP_MAP_FILE",
            &mut out.se_op_names,
        );
        load_i64_name_map_env(
            "SIGLUS_PCM_OP_MAP",
            "SIGLUS_PCM_OP_MAP_FILE",
            &mut out.pcm_op_names,
        );
        load_i64_name_map_env(
            "SIGLUS_MOV_OP_MAP",
            "SIGLUS_MOV_OP_MAP_FILE",
            &mut out.mov_op_names,
        );
        load_i64_name_map_env(
            "SIGLUS_EXCALL_OP_MAP",
            "SIGLUS_EXCALL_OP_MAP_FILE",
            &mut out.excall_op_names,
        );
        load_i64_name_map_env(
