...
static const float4 c8 = float4(1.0, 0.5, -2.0, -1.0);
...
PS_OUTPUT main(PS_INPUT input) {
    ...
    r0.w = (1.0 / input.t2.w);
    r0.x = (input.t2.x * r0.w + c8.x);
    r0.y = (input.t2.y * r0.w + c8.x);
    r0.x = (r0.x * c3.z);
    r1.w = c8.y;
    r0.z = (r0.x * r1.w + c3.x);
    r0.x = (r0.y * -(c8.y) + c8.x);
