...
static const float4 c7 = float4(1.0, 0.5, -1.0, 0.0);
...
PS_OUTPUT main(PS_INPUT input) {
    ...
    r0.y = (1.0 / input.t2.w);
    r0.z = (input.t2.x * r0.y + c7.x);
    r0.y = (input.t2.y * r0.y + c7.x);
    r0.z = (r0.z * c3.z);
    r0.w = c7.y;
    r0.w = (r0.z * r0.w + c3.x);
    r0.z = (r0.y * -(c7.y) + c7.x);
    ...
    r2.xyz = lerp(r0.xyz, c5.xyz, c5.www);
    r0.xyz = (r2.xyz + c6.xyz);
    r0.xyz = (r0.xyz + c7.zzz);
    r1.xyz = (r1.www * r0.xyz + c7.xxx);
    output.oC0 = r1;
    return output;
}
