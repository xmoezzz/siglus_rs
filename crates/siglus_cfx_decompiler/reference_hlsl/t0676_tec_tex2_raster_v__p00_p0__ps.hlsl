...
PS_OUTPUT main(PS_INPUT input) {
    ...
    r0.w = (-(input.t0.x) + c13.y);
    r0.x = (r0.w >= 0 ? c13.y : c13.x);
    r0.y = (input.t0.x >= 0 ? c13.y : c13.x);
    r0.x = (r0.x + r0.y);
    r0.x = (-(r0.x) >= 0 ? c13.y : c13.x);
    r0.y = (input.t0.x * c12.x);
    r0.z = frac(r0.y);
    r0.w = (r0.y + -(r0.z));
    r0.z = (-(r0.z) >= 0 ? c13.y : c13.x);
    r0.y = (r0.y >= 0 ? c13.y : c13.x);
    r0.y = (r0.y * r0.z + r0.w);
    r0.y = (r0.y + -(c0.x));
    r0.y = (r0.y * c1.x);
    r0.y = (r0.y * c12.y);
    ...
    r1.y = sin(r0.y);
    r1.x = (r1.y * c9.x + input.t0.y);
    r0.y = (r1.x >= 0 ? c13.y : c13.x);
    r0.x = (r0.x + r0.y);
    r0.x = (-(r0.x) >= 0 ? c13.y : c13.x);
    r0.y = (-(r1.x) + c13.y);
    r1.y = r1.x;
    ...
    r2 = tex2D(s0, r1.xy);
    r1 = tex2D(s1, r1.xy);
    r2 = (-(r0.xxxx) >= 0 ? c13.xxxx : r2);
    r0 = (-(r0.xxxx) >= 0 ? c13.xxxx : r1);
    r1 = (r2 * c11.xxxx);
    r0 = (r0 * c10.xxxx + r1);
    output.oC0 = r0;
    return output;
