...
VS_OUTPUT main(VS_INPUT input) {
    ...
    output.o3 = float4(0.0, 0.0, 0.0, 0.0);
    float4 r0 = float4(0.0, 0.0, 0.0, 0.0);
    float4 r1 = float4(0.0, 0.0, 0.0, 0.0);

    output.o1.x = dot(input.v1.xyz, c0.xyz);
    output.o1.y = dot(input.v1.xyz, c1.xyz);
    output.o1.z = dot(input.v1.xyz, c2.xyz);
    output.oD0 = (input.v3 * c8);
