...
static const float4 c11 = float4(0.0005, 1.0, 0.5, -2.0);
...
PS_OUTPUT main(PS_INPUT input) {
    ...
    r0.w = (1.0 / input.t3.w);
    r0.x = (input.t3.x * r0.w + c11.y);
    r0.y = (input.t3.y * r0.w + c11.y);
    r0.x = (r0.x * c6.z);
    r0.z = c11.z;
    r0.z = (r0.x * r0.z + c6.x);
    r0.x = (r0.y * -(c11.z) + c11.y);
    ...
    r0 = (c2.xxxx >= 0 ? r4 : r3);
    r0.w = dot(c8, r0);
    r2.xyz = lerp(r0.xyz, r0.www, c10.yyy);
    r2.w = c10.x;
    r0.x = r2.x;
    r0.y = r2.w;
    r2.x = r2.y;
    ...
    r3.x = r4.x;
    r3.y = r2.y;
    r0.xyz = (r3.xyz * c11.www + c11.yyy);
    r0.xyz = (c9.yyy * r0.xyz + r3.xyz);
    r2.xyz = lerp(r0.xyz, r0.www, c9.xxx);
    r0.xyz = (r2.xyz + c9.zzz);
    r1.xyz = (r0.xyz + -(c9.www));
    output.oC0 = r1;
    return output;
}
