...
static const float4 c4 = float4(-2.0, 1.0, -1.0, 0.0);
...
PS_OUTPUT main(PS_INPUT input) {
    ...
    r0 = (r0 * input.v0);
    r1.xyz = (r0.xyz * c4.xxx + c4.yyy);
    r1.xyz = (c1.yyy * r1.xyz + r0.xyz);
    r1.w = dot(c0, r0);
    r2.xyz = lerp(r1.xyz, r1.www, c1.xxx);
    r1.xyz = (r2.xyz + c1.zzz);
    r1.xyz = (r1.xyz + -(c1.www));
    r2.xyz = lerp(r1.xyz, c2.xyz, c2.www);
    r1.xyz = (r2.xyz + c3.xyz);
    r1.xyz = (r1.xyz + c4.zzz);
    r0.xyz = (r0.www * r1.xyz + c4.yyy);
    output.oC0 = r0;
    return output;
}
