...
static const float4 c10 = float4(1.0, 0.5, -2.0, -1.0);
...
PS_OUTPUT main(PS_INPUT input) {
    ...
    r0.w = (1.0 / input.t2.w);
    r0.x = (input.t2.x * r0.w + c10.x);
    r0.y = (input.t2.y * r0.w + c10.x);
    r0.x = (r0.x * c3.z);
    r1.w = c10.y;
    r0.z = (r0.x * r1.w + c3.x);
    r0.x = (r0.y * -(c10.y) + c10.x);
    ...
    r0.w = dot(c5, r0);
    r1.xyz = lerp(r0.xyz, r0.www, c9.yyy);
    r1.w = c9.x;
    r0.x = r1.x;
    r0.y = r1.w;
    r1.x = r1.y;
    ...
    r2.x = r3.x;
    r2.y = r1.y;
    r0.xyz = (r2.xyz * c10.zzz + c10.xxx);
    r0.xyz = (c6.yyy * r0.xyz + r2.xyz);
    ...
    r0.xyz = (input.v0.www * r0.xyz + c10.xxx);
    r0.w = input.v0.w;
    output.oC0 = r0;
    return output;
}
