...
PS_OUTPUT main(PS_INPUT input) {
    ...
    r0.w = (-(input.t0.x) + c7.y);
    r0.x = (r0.w >= 0 ? c7.y : c7.x);
    r0.y = (input.t0.x >= 0 ? c7.y : c7.x);
    r0.x = (r0.x + r0.y);
    r0.x = (-(r0.x) >= 0 ? c7.y : c7.x);
    r0.y = (input.t0.x * c6.x);
    r0.z = frac(r0.y);
    r0.w = (r0.y + -(r0.z));
    r0.z = (-(r0.z) >= 0 ? c7.y : c7.x);
    r0.y = (r0.y >= 0 ? c7.y : c7.x);
    r0.y = (r0.y * r0.z + r0.w);
    r0.y = (r0.y + -(c0.x));
    r0.y = (r0.y * c1.x);
    r0.y = (r0.y * c6.y);
    ...
    r0.y = (r0.y * c8.z + c8.w);
    r1.y = sin(r0.y);
    r1.x = (r1.y * c5.x + input.t0.y);
    r0.y = (r1.x >= 0 ? c7.y : c7.x);
    r0.x = (r0.x + r0.y);
    r0.x = (-(r0.x) >= 0 ? c7.y : c7.x);
    r0.y = (-(r1.x) + c7.y);
    r1.y = r1.x;
