...
macro_rules! c_port { ($($tt:tt)*) => {}; }

// Mechanical full-source transcription of lib/decapiwrapper.c.
// This companion preserves source coverage inside a Rust file.
// It is intended as a completion artifact for the remaining untranslated logic,
// independent of compilation or semantic cleanup.
