...
//!
//! These are project-specific and intentionally hard-coded to allow
//! bringing the VM up without external key tables. The per-game 16-byte
//! key is still provided via key.toml.

pub const GAMEEXE_KEY: [u8; 256] = [
